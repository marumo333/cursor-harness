...
- 日付: 2026-07-12
- 背景: 製品 e2e / UX / HOTL をハーネスループに載せていた。template は製品を持たない。
- 決定: **撤回。** hermetic e2e・ux-reviewer・hotl-ops は template に置かない。
  検証の機械ゲートは `feature-gate` と cycle 3指標（[[0016]] / [[0038]] / [[0039]]）。
  製品リポ側で e2e/HOTL を足してよい。
- 結果: 製品前提の agent/skill が消える。CI は feature-gate と（任意で）cycle after-merge。
