...
- Status: Accepted（Amends: [[0033]] [[0031]]；Amended by: [[0039]]）
- Date: 2026-07-24
- Context: Claude Opus 5 GA。0033 の枠（親 Grok＋Claude ゲート集中）を維持しつつゲート既定を Opus 5 にする。
- Decision:
  ...
  - **不変条件**: 独立 fresh context・敵対的レビュー、named agent 必須、Opus Task 入力は成果物のみ。
- Consequences: 製品 agent（auth-billing / ux-reviewer）は template に置かない（[[0039]]）。
- Links: [[0031]] [[0033]] [[0026]] [[0016]] [[0018]] [[0039]]
