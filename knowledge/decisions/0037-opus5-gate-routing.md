...
- 改正注記: 「Grok 4.5 据え置き」は [[0040]] で 4.6 に改正。Claude 席は Opus 5 固定（0026 の 4.8 は使わない）。Sol 第3席は維持。
- 日付: 2026-07-24
